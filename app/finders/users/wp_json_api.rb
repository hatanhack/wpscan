...
module WPScan
  module Finders
    module Users
      # WP JSON API
      #
      # Since 4.7 - Need more investigation as it seems WP 4.7.1 reduces the exposure, see https://github.com/hatanhack/wpscan/issues/1038)
      # For the pagination, see https://github.com/hatanhack/wpscan/issues/1285
      #
